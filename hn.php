...
<?php 
    ...
    if(!isset($_SESSION["username"])){
        ...
        $sql = "SELECT * FROM huongnghiep ORDER BY huongnghiep.id DESC";
...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            <table class="table">
                <a class="btn btn-primary" href="themhn.php">Thêm Mới</a>
                ...
                <tbody>
                    <?php
                        ...
                        <tr>
                            ...
                            <td><a href="suahn.php?id=<?php echo $row['id']; ?>">Sửa</a></td>
                            <td>
                            <a onclick="return Del('<?php echo $row['tieude'];?>')" href="xoahn.php?id=<?php echo $row['id']; ?>">Xóa</a>
                            </td>
                        </tr>
                    <?php }?>
