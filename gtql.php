...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            <table class="table">
                <a class="btn btn-primary" href="themgt.php">Thêm Mới</a>
                <thead class="thead-light">
                    <tr>
                    <th scope="col">STT</th>
                    <th scope="col">Công tác khuyến học</th>
                    <th scope="col">Chức năng nhiệm vụ</th>
                    <th scope="col">Sửa</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                        ...
                        <tr>
                            <td><?php echo $i++; ?></td>
                            <td><?php echo $row['ctkh']; ?></td>
                            <td><?php echo $row['chucnang']; ?></td>
                            <td><a href="suagt.php?id=<?php echo $row['id']; ?>">Sửa</a></td>        
                        </tr>
