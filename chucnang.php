...
<head>
    ...
    <title>Quản Lý Công Tác Khuyến Học - Giới Thiệu</title>
...
<body>
        ...
        <nav>
            <div class="menu">
                <ul>
                    ...
                    <li class="active"><a href="gt.php" target="_black">Giới Thiệu</a></li>
    ...
    <div class="main">
        ...
        <div class="back">
            <h3 class="fas fa-list">   <b>Giới Thiệu </b></h3>
            <ul>
                <li><a href="gt.php">Công Tác Khuyến Học</a></li>
                <li><a href="chucnang.php" class="active">Chức Năng và Nhiệm Vụ</a></li>
                
            </ul>
        </div>
        <article>
            <div class="chucnang">
                <h3 class="fas fa-bookmark"> <b>CHỨC NĂNG VÀ NHIỆM VỤ:</b></h3><br>
                <section>
                    <table border="0">
                <?php 
                            $result = mysqli_query($conn, "SELECT * FROM gioithieu ") or die ("Lỗi truy vấn");
                            $r = mysqli_fetch_array($result);
                            while ($r = mysqli_fetch_array($result)){?>
                                <tr>
                                    <th  class="aa"> <?php echo $r['chucnang']; ?></th>
                                </tr>
