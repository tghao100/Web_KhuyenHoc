...
<body>
    ...
    <div class="main">
        ...
        <div class="back">
            <h3 class="fas fa-list">    Giới Thiệu</h3>
            <ul>
                <li><a href="" class="active">Công Tác Khuyến Học</a></li>
                <li><a href="chucnang.php">Chức Năng và Nhiệm Vụ</a></li>
                
            </ul>
        </div>
        <article>
            <div class="gioithieu">
                <h3 class="fas fa-bookmark"> <b>GIỚI THIỆU CÔNG TÁC KHUYẾN HỌC:</b></h3><br>
                <section>
                <table border="0">
                <?php 
                            ...
                            while ($r = mysqli_fetch_array($result)){?>
                                <tr>
                                    <th  class="aa"> <?php echo $r['ctkh']; ?></th>
                                </tr>
