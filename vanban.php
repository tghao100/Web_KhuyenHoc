...
<?php 
    ...
    if(!isset($_SESSION["username"])){
        ...
        $sql = "SELECT * FROM vanban ORDER BY vanban.id DESC";
...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-header">
            <h2>Văn Bản và Đề án</h2>
        </div>
        <div class="card-body">
            <table class="table">
                <a class="btn btn-primary" href="themvb.php">Thêm Mới</a>
                <thead class="thead-light">
                    <tr>
                    <th scope="col">STT</th>
                    <th scope="col">Văn Bản</th>
                    <th scope="col">Đề án</th>
                    <th scope="col">Link Văn Bản</th>
                    <th scope="col">Link Đề án</th>
                    <th scope="col">Sửa</th>
                    <th scope="col">Xóa</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                        ...
                        <tr>
                            <td><?php echo $i++; ?></td>
                            <td><?php echo $row['vanban']; ?></td>
                            <td><?php echo $row['dean']; ?></td>
                            <td><?php echo $row['linkvb']; ?></td>
                            <td><?php echo $row['linkda']; ?></td>
                            <td><a href="suavb.php?id=<?php echo $row['id']; ?>">Sửa</a></td>
                            <td>
                            <a onclick="return Del('<?php echo $row['vanban'];?>')" href="xoavb.php?id=<?php echo $row['id']; ?>">Xóa</a>
                        </td>
                    </tr>
                        <?php }?>
