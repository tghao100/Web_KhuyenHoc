...
<?php 
    ...
    if(!isset($_SESSION["username"])){
        ...
        $sql = "SELECT * FROM tintuc ORDER BY tintuc.id DESC";
...
<div class="container-fluid">
    <div class="card">
        ...
        <div class="card-body">
            <table class="table">
                <a class="btn btn-primary" href="themtt.php">Thêm Mới</a>
                ...
                <?php
                        ...
                        <td>
                        <a onclick="return Del('<?php echo $row['tieude'];?>')" href="xoatt.php?id=<?php echo $row['id']; ?>">Xóa</a>
                        </td>
                    </tr>
                        <?php }?>
